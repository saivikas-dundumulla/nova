...
Add a GitHub Actions workflow with `azure/webapps-deploy@v3` using a publish profile or OIDC, deploying the repo on push to `master`. The same App Settings and startup command apply.
